...
<head>
    <title>梦想试衣间</title>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/css/user/userDetail.css">
<script src="<%=basePath%>/js/jquery-3.3.1.js"></script>
<script src="<%=basePath%>/js/user/userDetail.js">
</script>
</head>
<body>
<form id="registrationForm"   enctype="multipart/form-data" oninput="showAvatars()">
    ...
    <input type="button" class="exit" onclick=exit() value="关闭">
</form>
</body>
</html>
